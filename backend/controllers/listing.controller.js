...
export const addListing = async (req,res) => {
    try {
        let host = req.userId;
        // we take details from body and cloudinary
...
// help to add list in sorted manner ( newly list add at 1st place)
...
// help to update the previous list
...
// help to get list by id and then delete that list
...
// help to give rating , search the list by its id
...
// help in searching list in search bar
