...
// calculate total nights and total charges
// price calculate on basis person live total night
            useEffect(()=>{
                if(checkIn && checkOut){
   ...
   // help in updating the previous list
    ...
    // help user to upload 1 or 2 or 3 images
    // if backend img exist then append img 
     ...
     // help in deleting previous list
    ...
    const handleImage3 = (e)=>{
        ...
        // calculate today date (during booking set min date == today )
        // at previous date we cannot book
    useEffect(()=>{
