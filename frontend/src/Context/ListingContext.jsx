...
// we add all listing details in form data
    ...
    //   we send these deatils in backend(in the form of link or files) and then we fetch from backend and append to frontend
    ...
    //  help in find list by id and then update , navigate
...
// function to get list data frombackend
     const getListing = async () => {
        try {
            let result = await axios.get( serverUrl + "/api/listing/get",{withCredentials:true})
            setListingData(result.data)
            // list data contains all cards
            setNewListData(result.data)
            // new list data is make for help in category wise search
